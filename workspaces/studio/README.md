...
When you deploy your application to a live URL, you **must** update your Google Cloud and environment variables for authentication to work. For your specific deployment (`studio--studio-7958592768-de205.us-central1.hosted.app`), follow these exact steps.
...
```env
# Set this to your exact production URL
NEXTAUTH_URL=https://studio--studio-7958592768-de205.us-central1.hosted.app
```
**Important:** You must set this environment variable in your hosting provider's settings (e.g., Firebase App Hosting, Vercel).
...
3.  Under **Authorized JavaScript origins**, click **+ ADD URI** and add your production URL:
    - `https://studio--studio-7958592768-de205.us-central1.hosted.app`
4.  Under **Authorized redirect URIs**, click **+ ADD URI** and add your production callback URL. This must match your `NEXTAUTH_URL` + `/api/auth/callback/google`:
    - `https://studio--studio-7958592768-de205.us-central1.hosted.app/api/auth/callback/google`
5.  Click **Save**.
